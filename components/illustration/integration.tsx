  ...
  return (
    ...
    >
      <div className="flex h-full w-full flex-col items-center justify-center">
        {/* server illustration */}
        <CancelBugIllustration />
      </div>
    </div>
  );
};

const BugIllustration = () => (
  <svg viewBox="0 0 24 24" width="70" height="70" preserveAspectRatio="xMidYMid meet">
    <g>
      {/* linear greadient */}
      <defs>
        <linearGradient id="bugGradient" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" stopColor="#9A3412" /> {/* Orange 900 */}
        </linearGradient>
        <filter id="bugGlow" x="-20%" y="-20%" width="140%" height="140%">
...
const CancelBugIllustration = () => (
  <div className="relative flex h-28 w-28 items-center justify-center">
    ...
    >
      ...
      >
        <defs>
          <linearGradient id="cancelRed" x1="0%" y1="0%" x2="100%" y2="100%">
