      ...
      <div className="relative z-10 mx-auto max-w-5xl">
        ...
        >
          ...
          <p className="mt-2 text-xs text-neutral-400 sm:text-sm">
            Click on any diagram to view full screen
          </p>
        </AnimatedDiv>
          ...
          {roles.map((role: Role, index) => (
            ...
            >
              <div className="flex flex-col gap-2 overflow-hidden">
                ...
                >
                  {/* Expand Hint Overlay */}
                  <div className="absolute top-3 right-3 z-20 flex items-center gap-1.5 rounded-full border border-neutral-700/80 bg-neutral-900/80 px-2.5 py-1 text-[11px] font-medium text-neutral-300 backdrop-blur-md transition-all group-hover/canvas:border-neutral-400 group-hover/canvas:bg-neutral-800 group-hover/canvas:text-white">
                ...
                <p className="mb-2 text-xs leading-relaxed text-neutral-400 sm:text-sm">
                  {role.description}
                </p>
