...
const projects: ProjectItem[] = [
  {
    ...
    description:
      'Multi-tenant healthcare SaaS engineered for patient management and recovery tracking. Designed database isolation and indexed MongoDB query pipelines to reduce response latencies down to <50ms for practitioner analytics.',
    ...
    tags: ['MERN Stack', 'TypeScript', 'MongoDB Indexing', 'Multi-Tenant', 'Express'],
    featured: true,
  },
  {
    id: 'chess',
    ...
    description:
      'Built a real-time state synchronization engine over WebSockets handling chess move validation, live clocks, and pub/sub match updates with sub-50ms latency and zero re-render flickering.',
    image: '/projects/chess.png',
    github: 'https://github.com/PremRaj99/chess-fronend',
    demo: 'https://chess.premraj.online',
    tags: ['React', 'WebSockets', 'Pub/Sub', 'Node.js', 'TypeScript'],
    featured: true,
  },
  {
    id: 'yogalife',
    ...
    description:
      'High-converting studio storefront built with Next.js SSG/ISR, integrated with Razorpay/Stripe APIs and automated scheduling. Optimized asset prefetching to achieve sub-second page loads.',
    image: '/projects/yogalife.png',
    github: 'https://github.com/PremRaj99/Yogalife-Kolkata',
    demo: 'https://www.yogalifekolkata.com/',
    tags: ['Next.js', 'React', 'ISR Rendering', 'Payment Gateways', 'Tailwind CSS'],
    featured: true,
  },
  {
    id: 'statai',
    ...
    description:
      'Built an asynchronous Python ML inference pipeline to analyze audio frequency spectrums for mood categorization, delivering results via high-throughput REST APIs and real-time visualization dashboards.',
    image:
      'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=800&auto=format&fit=crop&q=80',
    github: 'https://github.com/PremRaj99/AI-Music-Mood-Classification',
    tags: ['Python ML', 'Async Pipelines', 'Next.js', 'TypeScript', 'REST API'],
    featured: false,
  },
  {
    id: 'videocall',
    ...
    description:
      'Implemented peer-to-peer WebRTC mesh routing paired with Socket.io signaling servers on a Node.js microservices architecture, maintaining sub-100ms video frame synchronization.',
    image: '/projects/videocall.png',
    github: 'https://github.com/PremRaj99/Web-RTC-Video-Call',
    demo: 'https://video.premraj.online',
    tags: ['WebRTC', 'Socket.io', 'Node.js', 'Microservices', 'React'],
    featured: false,
  },
  {
    id: 'snake',
    ...
    description:
      'Optimized a 60 FPS HTML5 Canvas rendering loop with input buffering and state-persistence in React & Vite, guaranteeing zero input latency across desktop and mobile devices.',
    image: '/projects/snake.png',
    github: 'https://github.com/PremRaj99/snake-game',
    demo: 'https://snake.premraj.online',
    tags: ['React', 'Vite', 'TypeScript', '60 FPS Canvas', 'State Sync'],
    featured: false,
  },
  {
    id: 'emerginet',
    ...
    description:
      'Designed a real-time emergency dispatch engine leveraging MongoDB GeoJSON spatial indexing to calculate dynamic proximity matches between drivers and repair providers within seconds.',
    image:
      'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=800&auto=format&fit=crop&q=80',
    github: 'https://github.com/PremRaj99/EmergiNet-Frontend',
    demo: 'https://emergi-net-frontend.vercel.app',
    tags: ['React', 'Node.js', 'GeoJSON Indexing', 'MongoDB', 'REST API'],
    featured: false,
  },
  {
    id: 'cyberhunter',
    ...
    description:
      'Architected a high-concurrency event registration and team management portal handling 1,000+ applicant submissions with role-based access control (RBAC).',
    image:
    ...
    tags: ['React', 'Node.js', 'RBAC Security', 'Tailwind CSS', 'Vercel'],
    featured: false,
  },
];
